...
class LLMEngine:
    ...
    def _add_processed_request(
        ...
        # chxu: Here, we compute the prompt hash, check whether perform kv-cache restore.
        if seq_group.need_kv_cache_restore_chxu():
            # logger.info(f'{request_id} has matched kv-cache!')
            # min_cost_scheduler.restore_seq_group_for_continue_decode_chxu(seq_group)
